                ...
                <div class="form-group">
                  <label for="salesDate">Date</label>
                    <div class="input-group">
                        ...
                        <input class="form-control date-picker" id="salesDate" name="salesDate"
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      var qnty = $('#qty').val();
      var total = "";
      var buttons = "<div class='hidden-sm hidden-xs btn-group'><button type='button' class='btn btn-xs btn-info'><i class='ace-icon fa fa-pencil bigger-120'></i></button><button type='button' class='btn btn-xs btn-danger'><i class='ace-icon fa fa-trash-o bigger-120'></i></button></div>"

      var tablerow = "<tr><td>"+buttons+"</td><td>"+batch+"</td><td>"+proname+"</td><td>"+batch+"</td><td>"+qnty+"</td><td>"+total+"</td></tr>";
