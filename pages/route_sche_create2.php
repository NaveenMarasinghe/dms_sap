                ...
                <div class="form-group">
                  <label for="rtscheDate">Schedule Date</label>                  
						<div class="input-group">
							...
							<input class="form-control date-picker" type="text" name="rtscheDate" 
              id="rtscheDate" data-date-format="dd-mm-yyyy"/>
						</div>
                </div>
              </div>
              <div class="col-md-3 form-group">
                  <div>
                    <label for="rtscheProGroup">Products Group</label>
                    <select name="rtscheProGroup" id="rtscheProGroup" class="form-control selcet-filter">
                     <option value="0">--Select Products Group--</option>                     
                    </select>                                       
                  </div>
              </div>                           
			</div>  
