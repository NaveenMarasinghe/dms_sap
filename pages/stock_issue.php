    ...
    <div class="form-actions">  
      <div>       
        ...
        <div class="box box-info">
        		<input  type="hidden" class="form-control date-picker" id="grndate" name="grndate"
            ...
            <div class="row"> 
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="proid">Salesman</label>
					<textarea id="salesman" class="form-control" readonly style=" overflow: hidden; resize: none; background: transparent;"></textarea>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="proid">Vehicle</label>
                    <div class="form-group">
						<textarea id="vehicle" class="form-control" readonly style=" overflow: hidden; resize: none; background: transparent;"></textarea>
                    </div>
                </div>
              </div>
