        ...
        <div class="col-xs-12">
            ...
            <div class="widget-box" style="height:100%">
                <div class="widget-header widget-header-blue widget-header-flat">
                    <h4 class="widget-title lighter">Edit Purchase Order</h4>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" class="form-control" value="<?php echo $_GET['purid'] ?>" id="poId" name="poId">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                <div>
                                                    ...
                                                    <input readonly type="text" class="form-control" id="poSupplier" name="poSupplier">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <div>
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        $(document).ready(function() {
            ...
            var poId = $('#poId').val();
            $.post("../controllers/controller_purchase.php?type=getEditSup", {
                poId: poId
                },
