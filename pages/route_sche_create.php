...
<div class="page-content">
	...
	<div class="row">
		...
		<div class="form-actions">	
			<div>       
        		<h4 class="page-header"><b>Create Route Schedule</b></h4>
      		</div>
...
<!--                         <span class="input-group-addon">
              ...
              <div class="col-md-3">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1" style="color: #F5F5F5">gg</label>
                    <div class="input-group">
<!--                         <span class="input-group-addon">
                          <input type="checkbox" class="column_filter" id="col2_smart">
                        </span> -->
                <a href="../pages/product_add.php" id="id-btn-dialog1" class="btn btn-purple btn-sm" style='margin-bottom: 10px;'>Add More Products</a>
                    </div>                    
                  </div>
              </div>                        
			</div>  
