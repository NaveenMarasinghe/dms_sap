        ...
        <div class="col-xs-12">
            ...
            <div class="form-actions">
                ...
                <table id="purTable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th data-override="batchid">Purchase Order ID</th>
                            <th data-override="productname">Date</th>
                            <th data-override="cusname">Item</th>
                            <th data-override="itemcost">Quantity</th>
                            <th data-override="itemmrp">Status</th>
                        </tr>
                    </thead>
                    <tbody id="purBody">
                        <tr>
    ...
    $(document).ready(function () {
        ...
        function myDatatable() {
            ...
            function pdf() {
                ...
                var head = [
                    ["Purchase ID", "Purchase Date", "Product Name", "Quantity", "Status"]
                ];
                ...
                doc.autoTable({
                        ...
                        didDrawPage: function (data) {
                            ...
                            doc.setFontSize(20);
                            doc.text(245, 80, "Purchase Report");
                            doc.setFontSize(11);
        ...
        $.post("../controllers/controller_reports.php?type=viewPurchaseSup", {
            supId: supId
            },
            function (data, status) {
                if (status == "success") {
