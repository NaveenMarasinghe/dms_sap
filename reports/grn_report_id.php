        ...
        <div class="col-xs-12">
            ...
            <div class="form-actions">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group" id="filter_col1" data-column="2">
                            <label for="selectSup">GRN ID</label>
                ...
                <table id="purTable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th data-override="batchid">Product Batch</th>
                            <th data-override="productname">Product Name</th>
                            <th data-override="cusname">Quantity</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        document.title = "Purchase Report - Supplier";
        ...
        function myDatatable() {
            ...
            function pdf() {
                ...
                var head = [
                    ["Product Batch", "Product Name", "Quantity", "Item Cost", "Item MRP"]
                ];
                ...
                doc.autoTable({
                        ...
                        didDrawPage: function (data) {
                            ...
                            doc.setFontSize(20);
                            doc.text(245, 85, "GRN Report");
                            doc.setFontSize(11);
                            doc.text(50, 105, "GRN ID : " + supname);
                            doc.setFont('times');
                            doc.setFontSize(11);
        ...
        $.post("../controllers/controller_reports.php?type=getGrn",
        ...
        var grnId = $('#selectSup').val();
        $.post("../controllers/controller_reports.php?type=viewGrn", {
            grnId: grnId
            },
            function (data, status) {
                if (status == "success") {
