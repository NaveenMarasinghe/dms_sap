                ...
                <table id="purTable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th data-override="cusname">Qunatity</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        document.title = "Inventory Report - Supplier";
            ...
            function pdf() {
                ...
                doc.autoTable({
                        ...
                        didDrawPage: function (data) {
                            ...
                            doc.setFontSize(20);
                            doc.text(230, 80, "Inventory Report");
                            doc.setFontSize(11);
        ...
        $.post("../controllers/controller_reports.php?type=viewInventorySup", {
            supId: supId
            },
            function (data, status) {
                if (status == "success") {
