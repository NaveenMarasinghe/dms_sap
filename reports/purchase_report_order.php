    ...
    <div class="col-xs-12">
      ...
      <div class="form-actions">
        ...
        <table id="salesTable" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th data-override="batchid">Purchase ID</th>
              <th data-override="productname">Purchase Date</th>
              <th data-override="cusname">Supplier Name</th>
              <th data-override="itemcost">Status</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    document.title = "Purchase Report - Date Range";
    ...
    function myDatatable() {
      ...
      function pdf() {
        ...
        var head = [
          ["Purchase ID", "Purchase Date", "Supplier Name", "Status"]
        ];
        ...
        doc.autoTable({
            ...
            didDrawPage: function (data) {
              ...
              doc.setFontSize(20);
              doc.text(245, 85, "Purchase Report");
              doc.setFontSize(13);
    ...
    function buildTbl() {
      var startDate = $('#startDate').val();
      var endDate = $('#endDate').val();
      $.post("../controllers/controller_reports.php?type=viewPurchaseDate", {
          startDate: startDate,
          endDate: endDate
        },
