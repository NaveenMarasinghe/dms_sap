...
function addNewProduct()
{
	...
	$sql = "INSERT INTO tbl_products(pro_id,pro_cat_id,pro_subcat_id,pro_name,pro_sup_id,pro_status,pro_reorder)
		VALUES('$proid','$cat','$subcat','$product','$supid','$status','$reorder');";
